...
namespace AITalentHub.Controllers
{
    ...
    public class ApplicationsController : ControllerBase
    {
        ...
        public ApplicationsController(AppDbContext context, IMatchingService matchingService, IAuditLogService auditLogService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Apply([FromBody] ApplyDto dto)
        {
            ...
            await _auditLogService.LogAsync(new AuditLog
            {
                ...
                Details = $"Candidate {userInfo.Email} applied to job ID {dto.JobPostId}."
            });
        ...
        public async Task<IActionResult> UpdateStatus(int id, [FromBody] UpdateStatusDto dto)
        {
            ...
            await _auditLogService.LogAsync(new AuditLog
            {
                ...
                Entity = "Application",
                EntityId = app.Id.ToString(),
                Details = $"Application status changed to '{app.Status}' by {userInfo.Email}."
            });
        ...
        public async Task<IActionResult> ScheduleInterview(int id, [FromBody] ScheduleInterviewDto dto)
        {
            ...
            await _auditLogService.LogAsync(new AuditLog
            {
                ...
                Details = $"Interview scheduled for application {app.Id} by {userInfo.Email}."
            });
